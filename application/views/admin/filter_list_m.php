...
<div id="wrapper">
        ...
        <div id="page-wrapper" style="background-image:url('<?php echo base_url().'assets/';?>img/back.png');background-repeat:no-repeat;background-position:bottom right">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">TAMPILKAN SEMUA DATA</h3>
                    <a href="http://localhost/lapgas/admin/l_mahasiswa" style="text-decoration:none"> <button class="btn btn-default">SUBMIT</button> </a>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->            
